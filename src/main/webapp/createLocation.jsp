...
<form action="createLocation" method="post">
    <b>Country -> </b><input name="country"/><br/><br/>
    <b>City -> </b><input name="city"/><br/><br/>
    <b>Street -> </b><input name="street"/><br/><br/>
    <b>house -> </b><input name="house"/><br/><br/>
    <b>room -> </b><input name="room"/><br/><br/>
