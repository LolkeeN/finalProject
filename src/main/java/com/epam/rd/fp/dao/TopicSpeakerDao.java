...
public class TopicSpeakerDao {
    ...
    public void bindTopicWithSpeakerId(Connection conn, int topic_id, int speaker_id) {
        try (PreparedStatement prepStat = conn.prepareStatement("INSERT INTO topic_speaker (topic_id, speaker_id) values (?, ?)");
        ) {
    ...
    public List<Topic> getTopicIdBySpeakerId(Connection conn, int speakerId) {
        ...
        try (PreparedStatement prepStat = conn.prepareStatement("SELECT * FROM topic_speaker WHERE speaker_id = ?");
        ) {
    ...
    public int getSpeakerIdByTopicId(Connection conn, int topicId) {
        ...
        try (PreparedStatement prepStat = conn.prepareStatement("SELECT * FROM topic_speaker WHERE topic_id = ?");
        ) {
